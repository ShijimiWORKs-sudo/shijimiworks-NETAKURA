...
- `docs/hp_embed.md` を作成
- HP掲載用の短い紹介文と長めの紹介文を整理
- 推奨ボタン文言を「試してみる」として整理
- Vercel公開URL差し替え用のリンクHTMLを作成
- 開発中デモ版としての注意書きを整理
- iframeではなくリンク掲載を推奨する理由を整理
- スマホ表示時の注意と掲載後の確認項目を整理

## 2026-07-07 法務・問い合わせ導線追加

- 全ページ共通フッターに利用規約、プライバシーポリシー、免責事項、問い合わせ、運営者情報、特商法表記へのリンクを追加
- 設定画面に「サポート・規約」セクションを追加
- 問い合わせページを開発中デモ版向けの仮文言に更新
- 通常ブラウザ表示ページからロゴ画像以外の商品名テキストを削除
- スマホ幅でフッターリンクが横にはみ出さないことを確認
